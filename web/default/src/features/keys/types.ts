...
export const apiKeySchema = z.object({
  ...
  rate_limit_rpm: z.coerce.number().int().min(0).catch(0),
  rate_limit_tpm: z.coerce.number().int().min(0).catch(0),
  model_quota_limits: z.string().nullish().default(''),
})
